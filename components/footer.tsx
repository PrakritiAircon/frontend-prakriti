...
export function Footer() {
  ...
  const services = ["Ducting Materials", "Ducting Work", "Symphony Evaporative Coolers", "System Maintenance", "Energy Audits"]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-2xl font-bold text-blue-400">Prakriti Aircon</h3>
            </div>
            <p className="text-gray-300 text-pretty">
              ...
              focus on sustainability and energy efficiency. Authorized Symphony Official Dealer with genuine products
              and complete warranty support.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-gray-300 text-sm">sales@prakritiaircon.com</p>
              </div>
            </div>
          </div>
        </div>
